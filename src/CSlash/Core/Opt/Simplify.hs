...
--     do_iteration iteration_no counts_so_far binds
...
--   -> CoreProgram
--   -> IO ()
-- dump_end_iteration logger dump_core_sizes name_ppr_ctx iteration_no counts binds
--   = dumpPassResult logger dump_core_sizes name_ppr_ctx mb_flag hdr ppr_counts binds
--   where

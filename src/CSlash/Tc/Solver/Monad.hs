...
kickOutAfterFillingCoercionHole :: TcKindCoercionHole -> TcS ()
...
newWanted :: CtLoc -> RewriterSet -> TcPredKind -> TcS MaybeNew
...
checkReductionDepth :: CtLoc -> TcMonoKind -> TcS ()
...
solverDepthError :: CtLoc -> TcMonoKind -> TcM a
